 ...
 */
//Accessor
const bool& AnimationComponent::IsDone(const Animation_e key)
{
 ...
 */
//Functions
void AnimationComponent::AddAnimation(const Animation_e key, float animation_timer, int start_frame_x,
 ...
 */
const bool& AnimationComponent::Play(const Animation_e key, const float& delta, const bool priority)
{
